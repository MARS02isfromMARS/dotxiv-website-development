...
const categories = [
  ...
  { 
    label: '05', 
    title: 'Cosmology', 
    text: 'A first-principles map of the expanding universe.', 
    tone: 'teal',
    icon: Globe2
  },
]
      ...
      <section id="notes" className="notes-section page-pad">
        ...
        <div className="category-grid">
          {categories.map((category) => {
            ...
            return (
              <Link href="#notes" className={`category-card ${category.tone}`} key={category.label}>
                ...
                <p>{category.text}</p>
                <span className="category-link">Click to explore <ArrowUpRight size={14} /></span>
              </Link>
            )
          })}
        </div>
